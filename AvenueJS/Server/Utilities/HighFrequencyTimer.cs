...
namespace AvenueJS.Server.Utilities
{
	// Borrowed from ShootR
	// https://github.com/NTaylorMullen/ShootR/blob/master/ShootR/ShootR/Server/Utilities/HighFrequencyTimer.cs
